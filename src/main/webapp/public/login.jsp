...
.hero-content h1 { font-size: 2.6rem; font-weight: 700; }
.hero-content p { font-size: 1.2rem; margin-top: 12px; }
.hero-content .btn {
    padding: 12px 26px;
    border-radius: 30px;
    font-size: 1rem;
...
/* SECTIONS */
.section-title { font-weight: 700; color: #114b8c; }
.card {
    border: none;
    border-radius: 14px;
...
<section class="hero">
    ...
    <div class="hero-content-wrapper">
        <div class="hero-content" data-aos="fade-up" data-aos-duration="1200">
            ...
            <a class="btn btn-warning fw-semibold mt-3" data-bs-toggle="modal" data-bs-target="#loginModal">
                Access TMIS Portal
            </a>
        </div>
    </div>
...
© 2026 Training Management Information System (TMIS) | Developed by CTI, Jabalpur
</footer>
...
<script>
AOS.init({ once:true, offset:120, easing:'ease-out-cubic' });
</script>
