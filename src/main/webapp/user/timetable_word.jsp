		...
		<body>
			...
			<div class="sheet">
				...
				<div class="header">
					...
					<p>
						<%= request.getParameter("post") %> नियमित का एक माह का क्लास रूम प्रशिक्षण
					</p>
				...
				<div class="extra-info">
					<div>क्र./ अति. मु.महा.प्र./ केप्रसं / <%= request.getParameter("post") %>
					</div>
					<b>
				...
				<table>
					...
					String batch=request.getParameter("batch");
						...
						ps.setInt(1, Integer.parseInt(postIdStr)); 
						ps.setString(2, batch); 
						ps.setString(3, year);
						ResultSet rs=ps.executeQuery(); 
						// Step 1: Store all rows in a List to calculate rowspan
				...
				<!-- NOTE BELOW TABLE -->
				<div class="note">
					नोट- प्रत्येक दिन दोपहर 01-30 बजे से 02-30 बजे तक का समय भोजनावकाश के लिए निर्धारित किया गया है।
				</div>
...
<%-- <div class="button-group">
   ...
   <button onclick="downloadWord()">Download Word</button>
    ...
    <button onclick="location.href='select_post.jsp'">Back</button>
</div> --%>
...
function downloadWord(){
    ...
    window.location.href = "<%= request.getContextPath() %>/timetable_word.jsp?" + params;
